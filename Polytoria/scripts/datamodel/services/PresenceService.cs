...
{
	private const long DiscordAppID = 1510593999176466494;
	private const string GamePresenceText = "Playing Kryndora";
	private const string StudioBuildPresenceText = "Building in Kryndora Studio";
	private const string StudioScriptPresenceText = "Scripting in Kryndora Studio";
	...
	private void UpdateDiscord()
	{
		...
		string defaultImg = "kryndora";
		string defaultSmallImg = "kryndora-sm";
		string defaultSmallText = Globals.AppDisplayName;

		if (Root.SessionType == World.SessionTypeEnum.Creator)
		{
			defaultImg = "studio";
			defaultSmallImg = "studio-sm";
			defaultSmallText = Globals.CreatorDisplayName;
			largeText = Globals.CreatorDisplayName;
			details = string.Equals(_state, StudioScriptPresenceText, StringComparison.Ordinal)
				? StudioScriptPresenceText
				: StudioBuildPresenceText;
		}
