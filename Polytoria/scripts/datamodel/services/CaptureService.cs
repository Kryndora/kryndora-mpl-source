...
public sealed partial class CaptureService : Instance
{
	...
	public void SaveCurrentPhoto()
	{
		...
		string filename = "KryndoraScreenshot-" + formattedTime + ".png";
		string baseFolder = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyPictures).PathJoin("Kryndora");
