...
{
	private const int BlackHatAssetId = 900007;
	...
	{
		if (id == BlackHatAssetId)
		{
			return BlackHatAccessory();
		}
	...
	private Accessory BlackHatAccessory()
	{
		LocalMeshAsset meshAsset = New<LocalMeshAsset>();
		meshAsset.EmbeddedFileExtension = ".glb";
		meshAsset.EmbeddedFileBytes = FileAccess.GetFileAsBytes("res://assets/accessories/black_hat.glb");
		...
		mesh.CanCollide = false;
		mesh.Anchored = true;
		mesh.LocalPosition = new Vector3(0, 17f, 0);
		accessory.Name = "Black Hat";
