...
{
	private static readonly string RootUrl = Globals.ApiEndpoint + "v1/assets/";
	private static readonly string ServeURL = RootUrl + "serve/";
	private static readonly string ServeMeshURL = RootUrl + "serve-mesh/";
	private static readonly string ServeAudioURL = RootUrl + "serve-audio/";
