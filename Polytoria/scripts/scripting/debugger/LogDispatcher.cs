...
public partial class LogDispatcher : NetworkedObject
{
	...
	{
		Player? requester = Root.Players.GetPlayerFromPeerID(RemoteSenderId);
		bool allowed = (requester != null && (requester.IsCreator || requester.IsAdmin)) || Globals.IsBetaBuild || (Root.Entry != null && Root.Entry.IsSoloTest);
		if (!allowed)
		{
			return;
		}
