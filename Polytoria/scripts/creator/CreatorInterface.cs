...
public partial class CreatorInterface : Control, IScriptObject
{
	...
	[ScriptProperty] public bool GizmoLocalSpace { get; internal set; } = false;
	...
	public async void OpenWorldFile(string filePath)
	{
		...
		else
		{
			...
			{
				bool yes = await PromptConfirmation("This file is in a legacy format. To edit it, you must convert it to a Kryndora project. Convert now?");
