...
public sealed partial class Gizmos : Node
{
	...
	public override void _Input(InputEvent @event)
	{
		...
		if (@event is InputEventKey lk && lk.Pressed && !lk.Echo && lk.Keycode == Key.L && !lk.CtrlPressed && !lk.AltPressed)
		{
			CreatorService.Interface.GizmoLocalSpace = !CreatorService.Interface.GizmoLocalSpace;
			CreatorService.Interface.StatusBar?.SetStatus("Move axes: " + (CreatorService.Interface.GizmoLocalSpace ? "Local" : "World"));
			return;
		}
